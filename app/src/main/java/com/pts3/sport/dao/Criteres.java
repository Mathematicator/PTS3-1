...
public class Criteres {
    ...
    public ArrayList<String> getAllChoix() {
        ArrayList<String> choix = new ArrayList<String>();
        if(!choix1.equals("null")){
            choix.add(choix1);
        }
        if(!choix2.equals("null")){
            choix.add(choix2);
        }
        if(!choix3.equals("null")){
            choix.add(choix3);
        }
        if(!choix4.equals("null")){
            choix.add(choix4);
        }
        if(!choix5.equals("null")){
            choix.add(choix5);
        }
        if(!choix6.equals("null")){
            choix.add(choix6);
        }
        return choix;
    }
    public ArrayList<Float> getAllNotes() {
