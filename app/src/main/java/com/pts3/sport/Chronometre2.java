...
public class Chronometre2 {
    ...
    Runnable updateTimerThread = new Runnable() {
        ...
        public void run() {
            ...
            ChronoActivity2.txtValue.setText("" + String.format("%02d", mins) + ":" + String.format("%02d", sec) + ":" + String.format("%03d", milliseconds));
    ...
    // Constructeur
    public Chronometre2(Context context, Handler handler) {
    ...
    public void affTemps() {
        ...
        ChronoActivity2.txtAffichage.setText(ChronoActivity2.txtAffichage.getText() + "\n" +i+"-"+ChronoActivity2.txtValue.getText());
        i++;
    }
}
